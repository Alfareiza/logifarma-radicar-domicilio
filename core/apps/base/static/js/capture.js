(function() {
  ...
  function startup() {
    ...
    input = document.getElementById('id_fotoFormulaMedica-src');
...
function myFunction() {
    var startbutton1 = document.getElementById('tomarfoto-btn');
    var startbutton2 = document.getElementById('tomarotrafoto-btn');
    var continuarbtn = document.getElementById("continuar-btn");
