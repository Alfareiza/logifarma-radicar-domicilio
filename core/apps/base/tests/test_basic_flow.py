...
class AllFLow(VisualWizardTests):
    ...
    def test_0_home_2_connect_to_instrucciones(self):
        self.process_home()
        title = self.selenium.title
    ...
    # def test_1_instrucciones_0_btn_continuar(self):
    #     boton_continuar = self.get_boton_continuar()
    #     self.assertTrue(boton_continuar, 'No se encontró el botón continuar')
    #     self.assertEqual(boton_continuar.text, 'Continuar')

    # def test_1_instrucciones_1_animacion(self):
    #     animacion = self.get_animacion()
    #     self.assertTrue(animacion, 'No se encontró la animación')
    #     self.assertEqual(animacion.value_of_css_property('display'), 'none', "Animación aparece al entrar en home")
    #     self.assertTrue(self.animacion_works(animacion), "Animación no aparece al clicar en continuar")

    # def test_1_instrucciones_2_btn_atras(self):
    ...
    def test_1_instrucciones_3_connect_to_autorizacion(self):
    ...
    # def test_2_autorizacion_0_btn_continuar(self):
    #     boton_continuar = self.get_boton_continuar()
    #     self.assertTrue(boton_continuar, 'No se encontró el botón continuar')
    #     self.assertEqual(boton_continuar.text, 'Continuar')

    # def test_2_autorizacion_1_btn_animacion(self):
    #     animacion = self.get_animacion()
    #     self.assertTrue(animacion, 'No se encontró la animación')
    #     self.assertEqual(animacion.value_of_css_property('display'), 'none', "Animación aparece al entrar en home")
    ...
    # def test_2_autorizacion_2_btn_atras(self):
    #     boton_atras = self.get_boton_atras()
    #     self.assertTrue(boton_atras, 'No se encontró el botón atrás')
    #     self.assertEqual(boton_atras.text, '< Atrás')
    #     boton_atras.click()
    ...
    # def test_2_autorizacion_2_ingresando_99_999_9999_y_enter_next_step(self):
    ...
    def test_2_autorizacion_3_connect_to_foto(self):
    ...
    def test_3_foto_0_connect_to_aviso_direccion(self):
        self.process_foto()
        self.assertEqual(self.selenium.title, 'Dirección')

    def test_4_aviso_direccion(self):
        print(f'===== TESTING ===== > {self.selenium.title}')
        title = self.selenium.title
        self.assertEqual(title, 'Dirección')

    # def test_4_aviso_0_btn_animacion(self):
    #     animacion = self.get_animacion()
    #     self.assertTrue(animacion, 'No se encontró la animación')
    #     self.assertEqual(animacion.value_of_css_property('display'), 'none', "Animación aparece al entrar en home")
    #     self.assertTrue(self.animacion_works(animacion), "Animación no aparece al clicar en continuar")

    def test_4_aviso_direccion_1_connect_to_elige_municipio(self):
        self.process_aviso_direccion()
        self.assertEqual(self.selenium.title, 'Elige Municipio')

    def test_5_municipio(self):
        print(f'===== TESTING ===== > {self.selenium.title}')
        title = self.selenium.title
        self.assertEqual(title, 'Elige Municipio')

    def test_5_municipio_0_connect_to_direccion_barrio(self):
        self.process_elige_municipio()
        self.assertEqual(self.selenium.title, 'Elige el barrio')

    def test_6_direccion_barrio(self):
        print(f'===== TESTING ===== > {self.selenium.title}')
        title = self.selenium.title
        self.assertEqual(title, 'Elige el barrio')

    def test_6_direccion_barrio_0_connect_to_celular(self):
        self.process_direccion_barrio()
        self.assertEqual(self.selenium.title, 'Digite celular')

    def test_7_celular(self):
        print(f'===== TESTING ===== > {self.selenium.title}')
        title = self.selenium.title
        self.assertEqual(title, 'Digite celular')

    def test_7_celular_0_connect_to_correo(self):
        self.process_celular()
        self.assertEqual(self.selenium.title, 'Digite un correo electrónico')

    def test_8_correo(self):
        print(f'===== TESTING ===== > {self.selenium.title}')
        title = self.selenium.title
        self.assertEqual(title, 'Digite un correo electrónico')

    def test_8_correo_0_connect_to_done(self):
        self.process_correo()
