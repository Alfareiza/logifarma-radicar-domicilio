...
def get_menu_items(context):
    """
    :rtype context: <class 'django.template.context.RequestContext'>
    :rparam context: [{'True': True, 'False': False, 'None': None},
                     {'csrf_token': <SimpleLazyObject: <function csrf.<locals>._get_val at 0x000001BC7434CA60>>,
                      'request': <WSGIRequest: GET '/inicio/'>,
                      'user': <SimpleLazyObject: <User: foo>>,
                      'perms': PermWrapper(<SimpleLazyObject: <User: foo>>),
                      'messages': <FallbackStorage: request=<WSGIRequest: GET '/inicio/'>>,
                      'DEFAULT_MESSAGE_LEVELS': {'DEBUG': 10, 'INFO': 20,
                      'SUCCESS': 25, 'WARNING': 30, 'ERROR': 40}},
                      {}, {'segment': 'index'},
                      {'block': <Block Node: sidebar. Contents: [<TextNode: '\n    '>, <IncludeNode: template=<FilterExpression "'includes/sidebar.html'">>,
                      <TextNode: '\n  '>]>}, {}]
    :return:
    In case of being a not superuser neither is is_staff :
            Ex.: []
    In case of being a not superuser but is_staff is True:
            Ex.: []
    In case of being a superuser who also is is_staff :
            Ex.:
            [{'app_label': 'auth',
              'current': False,
              'custom': False,
              ...
              'items': [{'current': False, 'has_perms': True,
                         'label': 'Grupos', 'name': 'group',
                         'object_name': 'Group', 'url': '/admin/auth/group/',
                         'url_blank': False},
                        {'current': False, 'has_perms': True,
                         'label': 'Usuarios', 'name': 'user',
                         'object_name': 'User', 'url': '/admin/auth/user/',
                         'url_blank': False}],
              'label': 'Autenticación y autorización',
              'models': [{'current': False, 'has_perms': True,
                          'label': 'Grupos', 'name': 'group',
                          'object_name': 'Group', 'url': '/admin/auth/group/',
                          'url_blank': False},
                         {'current': False, 'has_perms': True,
             ...
             {'app_label': 'base',
              ...
              'items': [{'current': False,
                         ...
                         'name': 'barrio',
                         'object_name': 'Barrio',
                         'url': '/admin/base/barrio/',
                         'url_blank': False},
                        {'current': False,
                         'has_perms': True,
                         'label': 'Municipios',
                         'name': 'municipio',
                         'object_name': 'Municipio',
                         'url': '/admin/base/municipio/',
                         'url_blank': False}],
              'label': 'Base',
              'models': [{'current': False,
                          'has_perms': True,
                          'label': 'Barrios',
                          'name': 'barrio',
                          'object_name': 'Barrio',
